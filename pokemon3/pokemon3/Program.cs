...
namespace pokemon3
{
    class pokemon
    {
        ...
        {
            public Tornadus() : base("Tornadus", 45, 52, 60, 43, 60, 42,"летающий","Facade, Metal Claw", "Спешный")
            {
            }
        }
        public class  Numel: pokemon
        {
            public Numel() : base("Numel", 40, 40, 20, 45, 25, 15, "огонь, наземный ", "Rest, Leer,Confide", "Скромный")
            {
            }
        }
